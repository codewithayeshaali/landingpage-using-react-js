...
export default function HandcraftedSection() {
  ...
  return (
    ...
    <section className="grid grid-cols-1 md:grid-cols-2 font-lato">
      <div ref={textRef} className="bg-[#002D69] text-white flex flex-col justify-center px-8 sm:px-14 lg:px-24 py-14 sm:py-20">
        <h3 className="text-[32px] sm:text-[30px] lg:text-[54px] font-semibold leading-tight mb-4">
          HAND CRAFTED
          <br />
          FINE PIECES.
        </h3>
        <p className="text-[18px] sm:text-[15px] lg:text-[28px] font-medium leading-[1.1] tracking-normal mb-8 max-w-[686px]">
